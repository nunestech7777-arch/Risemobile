-- ==============================================================================
-- RISEMOBILE: Migration 008 - Idempotência na Finalização de Venda
-- Impede que o mesmo pedido seja finalizado (baixa de estoque, pagamentos,
-- parcelas e faturamento) mais de uma vez.
-- ==============================================================================
...
BEGIN
    ...
    IF v_order.status = 'Finalizado' THEN
